...
public class PatientCheckInfo implements Serializable {
	...
	public PatientCheckInfo(String number, String name, String gender, String age, String telephone, String office, String classification, String price, String date, String type) {
		this.number = number;
		this.name = name;
		this.gender = gender;
		this.age = age;
